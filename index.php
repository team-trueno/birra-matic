...
<body>
    ...
    <header>
        <nav id="header" class="navbar fixed-top shadow navbar-expand-md navbar-dark bg-dark" role="navigation">
            <div class="container">
                <div class="navbar-toggler collapsed" data-toggle="collapse" data-target="#navbarNav"
            ...
            <span class="bar"></span> -->
                ...
                <a class="navbar-brand" href="#"><img class="img-fluid" src="img/logo_embirrados_chico.png"
                        alt="BirritApp"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <form class="form-inline">
                        <button class="btn btn-outline-warning" type="button" data-toggle="modal"
                            data-target="#modalLogin" data-whatever="@mdo">Login</button>
                    </form>
                </div>
            </div>
        </nav>
